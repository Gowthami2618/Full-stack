  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <GlassCard className="max-w-md w-full text-center p-8 border-rose-500/30">
        <div className="p-4 rounded-2xl bg-rose-500/15 text-rose-500 dark:text-rose-400 border border-rose-500/30 w-fit mx-auto mb-4">
          <ShieldAlert className="w-10 h-10" />
        </div>
        <h2 className="text-2xl font-serif font-bold text-slate-950 dark:text-white mb-2">
