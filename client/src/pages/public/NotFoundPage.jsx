  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <GlassCard className="max-w-md w-full text-center p-8 border-white/10">
        <div className="p-4 rounded-2xl bg-white/5 text-sky-400 border border-white/10 w-fit mx-auto mb-4">
          <HelpCircle className="w-10 h-10" />
        </div>
        <h2 className="text-3xl font-serif font-bold text-beige-100 mb-2">404</h2>
        <p className="text-sm font-semibold text-beige-200 mb-1">Page Not Found</p>
