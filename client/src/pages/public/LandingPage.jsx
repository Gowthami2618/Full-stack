    ...
    <div className="flex flex-col gap-24 pb-20 overflow-hidden">
      ...
      <section id="features" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-serif font-bold text-slate-100 mt-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <GlassCard className="flex flex-col justify-between border-sky-400/25">
            <div>
              <div className="p-3 w-fit rounded-xl bg-sky-500/15 text-sky-400 border border-sky-400/30 mb-6">
                <Palette className="w-6 h-6" />
              </div>
              <h3 className="text-xl font-serif font-bold text-slate-100 mb-2">For Clients</h3>
          ...
          <GlassCard className="flex flex-col justify-between border-sky-400/25">
            <div>
              ...
              <h3 className="text-xl font-serif font-bold text-slate-100 mb-2">For Designers</h3>
              <p className="text-xs text-slate-400 leading-relaxed mb-6">
          ...
          <GlassCard className="flex flex-col justify-between border-sky-400/25">
            <div>
              ...
              <h3 className="text-xl font-serif font-bold text-slate-100 mb-2">For Contractors</h3>
              <p className="text-xs text-slate-400 leading-relaxed mb-6">
      ...
      <section id="how-it-works" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <GlassCard className="p-8 sm:p-12 border-sky-400/20 bg-charcoal-900/70">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <span className="text-xs font-semibold text-sky-400 uppercase tracking-widest">
              End-to-End Execution
            </span>
            <h2 className="text-3xl font-serif font-bold text-slate-100 mt-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative">
            <div className="p-5 rounded-xl bg-charcoal-800/80 border border-sky-400/15 flex flex-col gap-3">
              <span className="text-xs font-bold text-sky-400">01 / BRIEF</span>
              <h4 className="text-base font-semibold text-slate-100">Project Brief</h4>
            ...
            <div className="p-5 rounded-xl bg-charcoal-800/80 border border-sky-400/15 flex flex-col gap-3">
              <span className="text-xs font-bold text-sky-400">02 / PROPOSAL</span>
              <h4 className="text-base font-semibold text-slate-100">Design Concept</h4>
              <p className="text-xs text-slate-400 leading-relaxed">
            ...
            <div className="p-5 rounded-xl bg-charcoal-800/80 border border-sky-400/15 flex flex-col gap-3">
              <span className="text-xs font-bold text-sky-400">03 / SIGN-OFF</span>
              <h4 className="text-base font-semibold text-slate-100">Client Approval</h4>
              <p className="text-xs text-slate-400 leading-relaxed">
            ...
            <div className="p-5 rounded-xl bg-charcoal-800/80 border border-sky-400/15 flex flex-col gap-3">
              <span className="text-xs font-bold text-sky-400">04 / FIT-OUT</span>
              <h4 className="text-base font-semibold text-slate-100">Bespoke Build</h4>
              <p className="text-xs text-slate-400 leading-relaxed">
