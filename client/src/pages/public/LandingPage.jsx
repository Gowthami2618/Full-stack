    ...
    <div className="flex flex-col gap-24 pb-20 overflow-hidden">
      ...
      <section className="relative pt-20 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full text-center flex flex-col items-center">
        ...
        <div className="relative z-10 flex flex-col items-center w-full">
          ...
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-serif font-bold text-slate-900 dark:text-slate-100 max-w-4xl tracking-tight leading-[1.1] mb-6 drop-shadow-xs">
            Design Your Space.{' '}
            <span className="sky-gradient-text block mt-1">Manage Every Detail.</span>
          </h1>

          <p className="text-sm sm:text-lg text-slate-600 dark:text-slate-300 max-w-2xl mx-auto leading-relaxed mb-10">
          ...
          <div className="mt-16 w-full max-w-5xl rounded-2xl glass-panel p-2.5 sm:p-4 border-sky-400/25 shadow-2xl relative">
            ...
            <div className="absolute bottom-6 left-6 right-6 sm:left-10 sm:right-10 glass-dropdown p-4 sm:p-6 rounded-xl border-sky-400/30 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="flex flex-col text-left">
                <span className="text-xs text-sky-500 dark:text-sky-400 font-semibold uppercase tracking-wider">
      ...
      <section id="features" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-serif font-bold text-slate-900 dark:text-slate-100 mt-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <GlassCard className="flex flex-col justify-between border-sky-400/25">
            <div>
              <div className="p-3 w-fit rounded-xl bg-sky-500/15 text-sky-500 dark:text-sky-400 border border-sky-400/30 mb-6">
                <Palette className="w-6 h-6" />
              </div>
              <h3 className="text-xl font-serif font-bold text-slate-900 dark:text-slate-100 mb-2">For Clients</h3>
          ...
          <GlassCard className="flex flex-col justify-between border-sky-400/25">
            <div>
              ...
              <h3 className="text-xl font-serif font-bold text-slate-900 dark:text-slate-100 mb-2">For Designers</h3>
              <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed mb-6">
          ...
          <GlassCard className="flex flex-col justify-between border-sky-400/25">
            <div>
              ...
              <h3 className="text-xl font-serif font-bold text-slate-900 dark:text-slate-100 mb-2">For Contractors</h3>
              <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed mb-6">
      ...
      <section id="how-it-works" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <GlassCard className="p-8 sm:p-12 border-sky-400/20">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <h2 className="text-3xl font-serif font-bold text-slate-900 dark:text-slate-100 mt-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative">
            <div className="p-5 rounded-xl glass-panel border border-sky-400/15 flex flex-col gap-3">
              <span className="text-xs font-bold text-sky-500 dark:text-sky-400">01 / BRIEF</span>
              <h4 className="text-base font-semibold text-slate-900 dark:text-slate-100">Project Brief</h4>
            ...
            <div className="p-5 rounded-xl glass-panel border border-sky-400/15 flex flex-col gap-3">
              <span className="text-xs font-bold text-sky-500 dark:text-sky-400">02 / PROPOSAL</span>
              <h4 className="text-base font-semibold text-slate-900 dark:text-slate-100">Design Concept</h4>
              <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
            ...
            <div className="p-5 rounded-xl glass-panel border border-sky-400/15 flex flex-col gap-3">
              <span className="text-xs font-bold text-sky-500 dark:text-sky-400">03 / SIGN-OFF</span>
              <h4 className="text-base font-semibold text-slate-900 dark:text-slate-100">Client Approval</h4>
              <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
            ...
            <div className="p-5 rounded-xl glass-panel border border-sky-400/15 flex flex-col gap-3">
              <span className="text-xs font-bold text-sky-500 dark:text-sky-400">04 / FIT-OUT</span>
              <h4 className="text-base font-semibold text-slate-900 dark:text-slate-100">Bespoke Build</h4>
              <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 w-full text-center">
        <div className="rounded-3xl glass-panel p-10 sm:p-16 border-sky-400/30 relative overflow-hidden shadow-2xl">
          ...
          <h2 className="text-3xl sm:text-5xl font-serif font-bold text-slate-900 dark:text-slate-100 mb-4">
            Ready to Elevate Your Interior Projects?
          </h2>
          <p className="text-xs sm:text-base text-slate-600 dark:text-slate-300 max-w-xl mx-auto mb-8 leading-relaxed">
